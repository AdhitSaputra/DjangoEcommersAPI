...
class PhoneNumber(models.Model):
    ...
    def send_confirmation(self):
        ...
        print(f"Sending security code {self.security_code} to {self.phone_number}")
...
class Address(models.Model):
    ...
    ADDRESS_CHOICHES = ((BILLING, _("billing")), (SHIPPING, _("shipping")))

    user = models.ForeignKey(User, related_name="addresses", on_delete=models.CASCADE)
    address_type = models.CharField(max_length=1, choices=ADDRESS_CHOICHES)
